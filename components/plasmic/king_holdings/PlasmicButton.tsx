...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Z0X_Dp4hOXh6/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xxMzV)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon7Icon
                className={classNames(projectcss.all, sty.svg__enjeJ)}
                role={"img"}
              />
            ),
